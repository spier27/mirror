(function() {
    ...
    function WeatherService($http) {
        ...
        service.currentforecast = function() {
            ...
            service.forecast.data.currently.temperature = parseFloat(service.forecast.data.currently.temperature).toFixed(1);
        ...
        service.weeklyforecast = function(){
            ...
            // Adds information that is readable by humans
